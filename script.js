function click_contact(){
    ...
    if(about_us.classList.contains("active")){
        ...
        let telefon = '<h1>Date de contact</h1><p>Telefon: 0722910000<br>'
...
function click_about_us(){
    ...
    if(contact.classList.contains("active")){
        ...
        let promo = document.getElementById("second-text")
        promo.innerHTML = '<p>V&#226;lcea ad&#259;poste&#351;te locuri &#238;nc&#226;nt&#259;toare. Cu bogate forme de relief, de la dealuri domoale la v&#226;rfuri muntoase,'.concat( 
